...
export class UniformCult {
    ...
    static __wrap(ptr) {
        const obj = Object.create(UniformCult.prototype);
        obj.ptr = ptr;
    ...
    free() {
        ...
        wasm.__wbg_uniformcult_free(ptr);
    }
    /**
    ...
    * @returns {UniformCult}
    */
    static new(num_watchers, fanout) {
        const ret = wasm.uniformcult_new(num_watchers, fanout);
        return UniformCult.__wrap(ret);
    }
    /**
    ...
    */
    add_color(inspired_watcher, color) {
        wasm.uniformcult_add_color(this.ptr, inspired_watcher, color);
    }
    /**
    ...
    */
    remove_color(inspired_watcher, color) {
        wasm.uniformcult_remove_color(this.ptr, inspired_watcher, color);
    }
}
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('pherogoose_bg.wasm', import.meta.url);
    }
    const imports = getImports();
